...
public record ServerConfig(
        ...
        boolean modRequired,
        Text modNotInstalledText
) {

    private static final Text DEFAULT_MOD_NOT_INSTALLED_TEXT = Text.literal(VoiceMessages.MOD_NAME + " is not installed or is of an old version");
    public static final Codec<ServerConfig> CODEC = RecordCodecBuilder.create(instance -> instance.group(
            ...
            defaultedField(TextCodecs.CODEC, "mod_not_installed_text", () -> DEFAULT_MOD_NOT_INSTALLED_TEXT).forGetter(ServerConfig::modNotInstalledText)
